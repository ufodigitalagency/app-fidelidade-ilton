...
st.markdown("""
    ...
    /* LINK WHATSAPP */
    .btn-zap { background-color: #25D366 !important; color: white !important; border-radius: 12px; border: none; padding: 18px; font-weight: 800; font-family: 'Montserrat', sans-serif; width: 100%; max-width: 350px; text-transform: uppercase; text-align: center; display: flex; justify-content: center; text-decoration: none; margin: 15px auto; box-shadow: 0 4px 15px rgba(37, 211, 102, 0.3); transition: 0.3s;}
...
def exibir_rodape_home():
    st.markdown("""
        <div class="rodape-container" style="bottom: 10px; background-color: transparent;">
...
def exibir_rodape_interno():
    st.markdown("""
        <div class="rodape-container" style="bottom: 25px; background-color: transparent;">
